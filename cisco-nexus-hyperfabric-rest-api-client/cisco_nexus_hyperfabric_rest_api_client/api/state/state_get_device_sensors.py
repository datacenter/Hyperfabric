...
from ...models.state_sensors_response import StateSensorsResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/fabrics/{fabric_id}/devices/{device_id}/sensors",
    }
...
) -> Optional[Union[CommonRestError, StateSensorsResponse]]:
    if response.status_code == 200:
        response_200 = StateSensorsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CommonRestError, StateSensorsResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CommonRestError, StateSensorsResponse]
    """
