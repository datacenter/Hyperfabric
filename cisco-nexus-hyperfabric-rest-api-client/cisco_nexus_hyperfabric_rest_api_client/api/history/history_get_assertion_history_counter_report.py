...
from ...models.reader_assert_counter_report_response import ReaderAssertCounterReportResponse
...
) -> Optional[Union[CommonRestError, ReaderAssertCounterReportResponse]]:
    if response.status_code == 200:
        response_200 = ReaderAssertCounterReportResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CommonRestError, ReaderAssertCounterReportResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CommonRestError, ReaderAssertCounterReportResponse]
    """
