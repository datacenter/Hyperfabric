...
from ...models.state_device_management_ports_response import StateDeviceManagementPortsResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/fabrics/{fabric_id}/devices/{device_id}/managementPorts",
    }
...
) -> Optional[Union[CommonRestError, StateDeviceManagementPortsResponse]]:
    if response.status_code == 200:
        response_200 = StateDeviceManagementPortsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CommonRestError, StateDeviceManagementPortsResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CommonRestError, StateDeviceManagementPortsResponse]
    """
