...
def sync_detailed(
    ...
    *,
    ...
    """Update the list of connections configuration in a specific fabric.

     This is a complete replacement of the connections in a fabric. If no connections exist new ones will
    be created.

    Args:
        fabric_id (str):
        body (ConfigSetFabricConnectionsRequest): Set the connections for a single fabric.
