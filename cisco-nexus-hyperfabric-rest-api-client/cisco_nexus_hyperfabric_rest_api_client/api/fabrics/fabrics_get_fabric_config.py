...
from ...models.config_get_fabric_config_response import ConfigGetFabricConfigResponse
...
def _get_kwargs(
    ...
    *,
    ...
    no_tenants: Union[Unset, bool] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    params["candidate"] = candidate

    params["noTenants"] = no_tenants

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/fabrics/{fabric_id}/configurations",
        "params": params,
    }
...
) -> Optional[Union[CommonRestError, ConfigGetFabricConfigResponse]]:
    if response.status_code == 200:
        response_200 = ConfigGetFabricConfigResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CommonRestError, ConfigGetFabricConfigResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CommonRestError, ConfigGetFabricConfigResponse]
    """
